    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                            ...
                            {{-- validation --}}
                            @error('title')
                            <p class="text-xs text-red-500 m-1">{{ $message }}</p>
                            @enderror
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div class="flex items-center">
                <button form="delete-form" class="text-red-500 text-sm"> Delete</button>
            </div>
